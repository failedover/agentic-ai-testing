...
ollama list - lists models that are downloaded
ollama ps - list models that are currently running
```
When interacting with a model:
```
   /bye   - exits the chat prompt
```
...
# Great visual guide
"Learn Ollama in 15 minutes" https://www.youtube.com/watch?v=UtSSMs6ObqY&t=313s
